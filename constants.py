...
SOURCE_SUMMARY_VARS = {"source_name":"Study Name", "Owner":"Owner", "Study type":"Study type", "Participant pathway": "Participant pathway", "Geographic coverage - Nations": "Geographic coverage - Nations", "Geographic coverage - Regions":"Geographic coverage - Regions",  "Start date":"Start date", "Age at recruitment": "Age at recruitment", "Sex":"Sex", "dataset_count":"Number of datasets", "participant_count":"Participant count", "Website": "Website"}
BLOCK_SUMMARY_VARS = {"table_name":"Table Name",  "collection_start": "Collection Start", "collection_end":"Collection End", "participants_included":"Participants Included", "links":"Link", "topic_tags":"Topics"}
BLOCK_TABLE_VARS = {"table": "Table ID", "table_name":"Table Name", "short_desc": "Description", "collection_start": "Collection Start", "collection_end":"Collection End", "participants_invited":"Participants Invited", "participants_included":"Participants Included", "links":"Link", "topic_tags":"Topics"}
